...
mathematical_constants = {'exp(1)','pi','2'};
...
var_at_checkpoints = [10,14,6];

Y_c = [3628800,8.717829120000000e+10,720];%.*[unifrnd(0.99,1.01),unifrnd(0.99,1.01),unifrnd(0.99,1.01)];

k = 15; %the length of the candidate_law_syntax
